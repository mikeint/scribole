        ...
        return (
            introPosition >= 19 ? 
                <div className='neverShowContainer'>
                    <Link to='games' className='neverShowAgainText' onClick={neverShowIntro}>Never Show Again</Link>
                    <Link  to='games' className='neverShowAgainText'>Take me to games</Link>
                </div>
            : ''
        )
    }
